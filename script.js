...
/*--------------------------------------------------------*/
// Declaração dos arrays filas
let filaPrioridade = [];
let filaRapido = [];
let filaComum = [];

// variavel contadora das filas
let cont = 0;

//FUNCOES DE ADICIONAR FILAS--------
//FUNCAO ADICIONAR FILA PRIORITARIO:
...
/*
CAIXA 1 PRIORITARIO,RAPIDO E COMUM-----------------------
Realiza os atendimentos preferenciais. Se não houver atendimentos preferenciais na fila, atende 
o próximo atendimento rápido. Se não houver também, atende o próximo comum. Se não houver nenhum,
não faz nada.
*/
